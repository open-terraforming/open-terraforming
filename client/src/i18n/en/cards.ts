export const cards = {
	...
	spin_off_department: 'Spin-Off Department',
	sub_zero_salt_fish: 'Sub-Zero Salt Fish',
	titanium_air_scrapping: 'Titanium Air Scrapping',
	titan_floating_launch_pad: 'Titan Floating Launch Pad',
